...
var floodExtentsMultiTableUrl =
  "https://fimnew.wim.usgs.gov/server/rest/services/FIMMapper/floodExtentsMulti/MapServer/1";
var floodExtentsMultiThreeSitesTableUrl =
  "https://fimnew.wim.usgs.gov/server/rest/services/FIMMapper/floodExtentsThreeSites/MapServer/1";
var fimHazusUrl =
...
var nwisUrl =
  "https://waterservices.usgs.gov/nwis/iv/?format=nwjson&period=P7D"; //&parameterCd=00060,00065,62614,62615&sites=";
var historicalUrl =
  "http://nwis.waterdata.usgs.gov/ms/nwis/peak?agency_cd=USGS&format=rdb&site_no=";
...
require([
  ...
  "dojo/domReady!",
], function (Extent, InfoTemplate, WMSLayerInfo, FeatureLayer) {
  var ahpsInfoTemplate = new InfoTemplate(
    "Flood stage: ${status}",
  ...
  allLayers = [
      ...
      layers: {
        "FIM Sites": {
          ...
          options: {
            ...
            definitionExpression:
              "(Public = 1 OR Public = 2) AND (MULTI_SITE = 0 OR MULTI_SITE = 1 OR MULTI_SITE = 3)",
        ...
        "FIM sites for print": {
          ...
          wimOptions: {
            ...
            layerDefinitions: [
              "(Public = 1) AND (MULTI_SITE = 0 OR MULTI_SITE = 1 OR MULTI_SITE = 3)",
            ],
            includeLegend: false,
            legendLabel: false,
          },
    ...
    },
    {
      ...
      includeInLayerList: true,
      moreinfo:
        "https://www.fws.gov/wetlands/Documents/Scalable-Wetland-Mapping-Fact-Sheet.pdf",
      otherLayersToggled: [
        "major",
        "moderate",
        "minor",
